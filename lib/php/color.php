...
class JElementColor extends JElement
{
	...
	{
		ob_start();
		$img=JUri::root()."templates/pure_white/images/rainbow/rainbow.png";
		$imgx=JUri::root()."templates/pure_white/images/rainbow/";
		static $embedded;
				if(!$embedded)
		{
			$css2=JUri::root()."templates/pure_white/css/mooRainbow.css";
			$jspath=JUri::root()."templates/pure_white/lib/js/mooRainbow.js";
			 ?>
<link
